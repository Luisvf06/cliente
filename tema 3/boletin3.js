...
var ventana=window.open('', '_blank', 'width=400,height=200');
...
let text2 = "<p>Browser CodeName: " + navigator.appCodeName + "</p>" + '<p>Nombre navegador: ' + navigator.appName + '</p> Versión: ' + navigator.appVersion;
document.write(text2);
*/
/*Crear dos enlaces, uno para abrir una nueva ventana y uno para cerrarla. 
La nueva ventana mostrará este mensaje en una fuente grande : ​”El ojo es la ventana a tu alma “. 
La nueva ventana se coloca en la esquina izquierda de la pantalla 
